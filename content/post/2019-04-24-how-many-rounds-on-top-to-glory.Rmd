...
Here we can see that, at the 5th round, all the champions have woned at least one game, and drawn at the most three games, with the minimum performance (points made / possible points) of 40%.
...
- So, we can note that the minimum number of rounds on top is 2 (Flamengo,  2009), while the maximum number is 38 (Cruzeiro, 2003) and the average is about 22 games. Looking on the proportions, we see that the champions often stays on the top a bit more than half of the championship (56,4%).

...
So, I've always been interesting in the ["xkcd type"]("https://xkcd.com/") of figures because **IT'S FUN**. 


My goal here is to make density plots of the most common probability functions.
...
- Ploting the Chi square (df = 3) desity.
...
There you have! A nice looking (sort of) density plot!